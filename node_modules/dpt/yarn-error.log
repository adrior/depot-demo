Arguments: 
  /usr/local/bin/node /usr/local/bin/yarn add github:yandex/dpt-scaffold

PATH: 
  ~/.cargo/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/usr/local/munki
...
npm manifest: 
  {
    ...
    "scripts": {
      ...
      "prepublish": "npm run babel && npm run webpack -- -p"
    },
    "author": "",
    "license": "ISC",
    "devDependencies": {
...
Lockfile: 
  ...
  autoprefixer@^6.0.2, autoprefixer@^6.3.1, autoprefixer@^6.3.6:
    version "6.7.3"
  ...
  babel-plugin-transform-es2015-modules-umd@^6.22.0, babel-plugin-transform-es2015-modules-umd@^6.8.0:
    version "6.23.0"
  ...
  babel-plugin-transform-flow-strip-types@^6.22.0, babel-plugin-transform-flow-strip-types@^6.7.0:
    version "6.22.0"
  ...
  debug@*, debug@2.6.1, debug@^2.1.1, debug@^2.2.0:
    version "2.6.1"
  ...
  lodash@^4.0.0, lodash@^4.2.0, lodash@^4.3.0, lodash@^4.8.2:
    version "4.17.4"
  ...
  postcss@^5.0.10, postcss@^5.0.11, postcss@^5.0.12, postcss@^5.0.13, postcss@^5.0.14, postcss@^5.0.16, postcss@^5.0.18, postcss@^5.0.19, postcss@^5.0.2, postcss@^5.0.4, postcss@^5.0.5, postcss@^5.0.6, postcss@^5.0.8, postcss@^5.2.13:
    version "5.2.14"
...
Trace: 
  Error: Error connecting to repository. Please, check the url.
      at /usr/local/lib/node_modules/yarn/lib/resolvers/exotics/hosted-git-resolver.js:162:15
      at next (native)
