...
var b = (0, _propmods2.default)('w-new-block');
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                ['block', 'title', 'lib', 'owner'].forEach(function (ref) {
                                    return form[ref] = _this2.refs[ref].value();
                                });
                                _cookie_js.cookie.set('username', form.owner, { path: '/', expires: 99999 });
                                _context2.next = 6;
                                return (0, _reqwest2.default)({
                                    url: '/api/wiki/blocks/',
                                    method: 'POST',
        ...
        value: function render() {
            if (this.state.loaded) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _wForm2.default,
                        { mix: 'w-new-block__form', flash: this.state.flash, onSubmit: this.handleSubmit.bind(this) },
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                { label: 'Block\'s name' },
                                _react2.default.createElement(_wInput2.default, { required: true, ref: 'block' })
                            ),
                            _react2.default.createElement(
                                _wForm2.default.Field,
                                { label: 'Description' },
                                _react2.default.createElement(_wInput2.default, { required: true, ref: 'title' })
                            ),
                            _react2.default.createElement(
                                _wForm2.default.Field,
                                { label: 'Library' },
                                _react2.default.createElement(
                                    _wSelect2.default,
                                    { defaultValue: this.props.currentLibrary, ref: 'lib' },
                                    libraries
                                )
                            ),
                            _react2.default.createElement(
                                _wForm2.default.Field,
                                { label: 'Maintainer' },
                                _react2.default.createElement(_wInput2.default, { defaultValue: _cookie_js.cookie.get('username'), ref: 'owner' })
                            )
                        ),
                        _react2.default.createElement(
